...
var padding = { top: 20, right: 40, bottom: 0, left: 0 },
    ...
    color = d3.scale.ordinal().range(["#2C3E50", "#8E44AD", "#2980B9", "#16A085", "#F39C12", "#D35400", "#C0392B", "#7F8C8D", "#27AE60", "#E74C3C", "#3498DB", "#FFD700"]); // Bleu marine chic
...
arcs.append("text").attr("transform", function(d) {
    ...
    .style("font-size", function(d, i) {
        return data[i].label === "T-shirt" ? "4vw" : "3vw";
    })
    .style("fill", function(d, i) {
        return data[i].label === "T-shirt" ? "red" : "black";
    })
    .attr("class", function(d, i) {
        return data[i].label === "T-shirt" ? "highlighted-text" : "";
    });

// Ajout de l'image SVG pour "T-shirt"
arcs.append("svg:image")
    .attr("xlink:href", function(d, i) {
        return data[i].label === "T-shirt" ? "star2.svg" : "";
    })
    .attr("width",  20)
    .attr("height", 20)
    .attr("transform", function(d) {
        ...
        d.outerRadius = r;
        d.angle = (d.startAngle + d.endAngle) / 2;
        return "rotate(" + (d.angle * 180 / Math.PI - 90) + ")translate(" + (d.outerRadius -90) + ",-10)";
    });
...
// Ajout de styles pour le texte "T-shirt"
var css = '.highlighted-text { animation: blink 1s infinite; font-size: 4vw; fill: red; } ' +
