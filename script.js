const data = [
    { label: "Spag X1 ", value: "200F Spaguetti X 1" },
    { label: "Savon X1 ", value: "200F Savon X 1" },
    { label: "Huile X1 ", value: "200F Huile X 1" },
    { label: "Riz ", value: "300F Riz" },
    { label: "Spag X2 ", value: "300F Spaguetti X 2" },
    { label: "Combo 1", value: "500F riz + huile + savon" },
    { label: "Huile X2 ", value: "300F Huile X 2" },
    { label: "Savon X2 ", value: "300F Savon X 2" },
    { label: "Combo 2", value: "400F Huile + Riz" },
    { label: "Riz ", value: "300F Riz" },
    { label: "500F Combo 2", value: "500F riz + huile + savon" },
